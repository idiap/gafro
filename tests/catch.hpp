...
#define INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION(Name, Tags, ...)                                                                          \
    INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION_2(                                                                \
      INTERNAL_CATCH_UNIQUE_NAME(C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), INTERNAL_CATCH_UNIQUE_NAME(C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_), Name, \
...
#else
#define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD(ClassName, Name, Tags, ...)                                                                         \
    INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_2(INTERNAL_CATCH_UNIQUE_NAME(C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_C_L_A_S_S_), \
...
#define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD(ClassName, Name, Tags, ...)                                                          \
    INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2(                                                           \
      INTERNAL_CATCH_UNIQUE_NAME(C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), INTERNAL_CATCH_UNIQUE_NAME(C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_), \
      ClassName, Name, Tags, typename T, __VA_ARGS__))
#endif
...
namespace Catch
{
    namespace Matchers
    {
        ...
        namespace Floating
        {
            ...
            // |lhs - rhs| <= epsilon * max(abs(lhs), abs(rhs)), then we get
...
namespace
{
    ...
    // Performs equivalent check of std::abs(lhs - rhs) <= margin
    ...
    namespace Detail
    {
        ...
        bool Approx::equalityComparisonImpl(const double other) const
        {
            ...
            return marginComparison(m_value, other, m_margin) ||
                   marginComparison(m_value, other, m_epsilon * (m_scale + std::abs(std::isinf(m_value) ? 0 : m_value)));
        }
