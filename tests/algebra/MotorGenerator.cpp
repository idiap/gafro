...
{
    gafro::Multivector<double, blades::e12, blades::e13, blades::e23, blades::e1i, blades::e2i, blades::e3i> mv({ 3.0, 2.0, 1.0, 4.0, 5.0, 6.0 });
...
{
    Motor<double>::Generator generator1({ 3.0, 2.0, 1.0, 4.0, 5.0, 6.0 });
...
{
    Motor<double>::Generator generator({ 3.0, 2.0, 1.0, 4.0, 5.0, 6.0 });
...
{
    Eigen::Matrix<double, 3, 1> p1({ 3.0, 2.0, 1.0 });
