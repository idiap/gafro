...
{
    gafro::Multivector<double, blades::e12, blades::e13, blades::e23> mv({ 1.0, 2.0, 3.0 });
...
TEST_CASE("Rotor Generator creation from parameters", "[RotorGenerator]")
{
    ...
    REQUIRE(generator.e12() == Approx(1.0));
    REQUIRE(generator.e13() == Approx(2.0));
    REQUIRE(generator.e23() == Approx(3.0));
...
{
    gafro::Multivector<double, blades::e12, blades::e13, blades::e23> mv1({ 1.0, 2.0, 3.0 });
    gafro::Multivector<double, blades::e12, blades::e13, blades::e23> mv2({ 10.0, 20.0, 30.0 });
    ...
    REQUIRE(generator.e12() == Approx(11.0));
    REQUIRE(generator.e13() == Approx(22.0));
    REQUIRE(generator.e23() == Approx(33.0));
}
