...
{
    gafro::Multivector<double, blades::e012i, blades::e013i, blades::e023i, blades::e123i> mv({ 1.0, 2.0, 3.0, 4.0 });
    Plane<double> plane(mv);

    REQUIRE(plane.get<blades::e012i>() == Approx(1.0));
    REQUIRE(plane.get<blades::e013i>() == Approx(2.0));
    REQUIRE(plane.get<blades::e023i>() == Approx(3.0));
    REQUIRE(plane.get<blades::e123i>() == Approx(4.0));
}
