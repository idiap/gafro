...
{
    gafro::Multivector<double, blades::scalar, blades::e12, blades::e13, blades::e23, blades::e1i, blades::e2i, blades::e3i, blades::e123i> mv(
...
{
    Motor<double>::Generator generator({ 0.0, 0.0, M_PI / 2.0, 1.0, 2.0, 3.0 });
...
TEST_CASE("Motor combination", "[Motor]")
{
    ...
    Rotor<double> rotor2({ 0.7071067812, 0.0, 0.0, -0.7071067812 });
