...
{
    gafro::Multivector<double, blades::e01i, blades::e02i, blades::e12i, blades::e03i, blades::e13i, blades::e23i> mv(
    ...
    REQUIRE(line.get<blades::e02i>() == Approx(2.0));
    REQUIRE(line.get<blades::e12i>() == Approx(3.0));
    REQUIRE(line.get<blades::e03i>() == Approx(4.0));
    REQUIRE(line.get<blades::e13i>() == Approx(5.0));
    REQUIRE(line.get<blades::e23i>() == Approx(6.0));
}
