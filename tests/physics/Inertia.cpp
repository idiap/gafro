...
TEST_CASE("Inertia creation from elements", "[Inertia]")
{
    ...
    SECTION("get elements")
    {
        InertiaElement<double> element = inertia.getElement01();

        REQUIRE(element.get<blades::e01>() == Approx(1.0).margin(1e-6));
        REQUIRE(element.get<blades::e02>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e12>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e03>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e13>() == Approx(0.0).margin(1e-6));
        ...
        REQUIRE(element.get<blades::e01>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e02>() == Approx(1.0).margin(1e-6));
        REQUIRE(element.get<blades::e12>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e03>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e13>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e23>() == Approx(0.0).margin(1e-6));
        ...
        REQUIRE(element.get<blades::e12>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e03>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e13>() == Approx(10.0).margin(1e-6));
        REQUIRE(element.get<blades::e23>() == Approx(0.0).margin(1e-6));
        ...
        REQUIRE(element.get<blades::e03>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e13>() == Approx(0.0).margin(1e-6));
        REQUIRE(element.get<blades::e23>() == Approx(10.0).margin(1e-6));
    }
}
...
TEST_CASE("Inertias addition", "[Inertia]")
{
    ...
    SECTION("in-place operator")
    {
        ...
        REQUIRE(tensor.coeff(0, 0) == Approx(30.0));
        REQUIRE(tensor.coeff(1, 1) == Approx(30.0));
        REQUIRE(tensor.coeff(2, 2) == Approx(66.0));
        REQUIRE(tensor.coeff(3, 3) == Approx(30.0).margin(1e-6));
        REQUIRE(tensor.coeff(4, 4) == Approx(44.0).margin(1e-6));
        REQUIRE(tensor.coeff(5, 5) == Approx(11.0).margin(1e-6));

        REQUIRE(tensor.coeff(4, 2) == Approx(-55.0));
        REQUIRE(tensor.coeff(2, 4) == Approx(-55.0));
        REQUIRE(tensor.coeff(5, 2) == Approx(33.0));
        REQUIRE(tensor.coeff(2, 5) == Approx(33.0));
        REQUIRE(tensor.coeff(5, 4) == Approx(-22.0));
        REQUIRE(tensor.coeff(4, 5) == Approx(-22.0));

        REQUIRE(tensor.coeff(0, 1) == Approx(0.0));
        REQUIRE(tensor.coeff(1, 0) == Approx(0.0));
        REQUIRE(tensor.coeff(3, 2) == Approx(0.0));
        REQUIRE(tensor.coeff(2, 3) == Approx(0.0));
        REQUIRE(tensor.coeff(4, 3) == Approx(0.0));
        REQUIRE(tensor.coeff(3, 4) == Approx(0.0));
        REQUIRE(tensor.coeff(5, 3) == Approx(0.0));
        REQUIRE(tensor.coeff(3, 5) == Approx(0.0));
...
TEST_CASE("Inertia transforms", "[Inertia]")
{
    ...
    SECTION("transform")
    {
        ...
        REQUIRE(tensor2.coeff(1, 3) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(1, 4) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(1, 5) == Approx(-10.0).margin(1e-6));
        REQUIRE(tensor2.coeff(2, 3) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(2, 4) == Approx(-3.0).margin(1e-6));
        REQUIRE(tensor2.coeff(2, 5) == Approx(-5.0).margin(1e-6));

        REQUIRE(tensor2.coeff(3, 0) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(3, 1) == Approx(0.0).margin(1e-6));
        ...
        REQUIRE(tensor2.coeff(4, 2) == Approx(-3.0).margin(1e-6));
        REQUIRE(tensor2.coeff(5, 0) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(5, 1) == Approx(-10.0).margin(1e-6));
        REQUIRE(tensor2.coeff(5, 2) == Approx(-5.0).margin(1e-6));

        REQUIRE(tensor2.coeff(3, 3) == Approx(10.0).margin(1e-6));
        REQUIRE(tensor2.coeff(3, 4) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(3, 5) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(4, 3) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(4, 4) == Approx(11.0).margin(1e-6));
        REQUIRE(tensor2.coeff(4, 5) == Approx(2.0).margin(1e-6));
        REQUIRE(tensor2.coeff(5, 3) == Approx(0.0).margin(1e-6));
        REQUIRE(tensor2.coeff(5, 4) == Approx(2.0).margin(1e-6));
        REQUIRE(tensor2.coeff(5, 5) == Approx(14.0).margin(1e-6));
    }
