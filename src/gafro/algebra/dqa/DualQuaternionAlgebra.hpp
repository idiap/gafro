...
template <int... index>
std::ostream &
  operator<<(std::ostream &ostream, const gafro::dqa::Multivector<double, index...> &dq)
{
    bool first = true;
...
std::ostream &
  operator<<(std::ostream &ostream, const gafro::Expression<Derived, gafro::dqa::Multivector<double, index...>> &expression)
{
