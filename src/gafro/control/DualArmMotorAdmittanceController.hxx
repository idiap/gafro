...
#include <gafro/control/DualArmMotorAdmittanceController.hpp>

namespace gafro
{

    template <int dof>
    DualArmMotorAdmittanceController<dof>::DualArmMotorAdmittanceController(const sackmesser::Interface::Ptr &interface, const std::string &name)
      : orwell::torque::AdmittanceController<dof, 12, DualArmMotorReference>(interface, name)
    {}
