...
namespace gafro
{
    ...
    class DualManipulator : public System<T>
    {
      public:
        ...
        MultivectorMatrix<T, Motor, 1, dof> getRelativeAnalyticJacobian(const Eigen::Vector<T, dof> &positions);
        ...
        MultivectorMatrix<T, MotorGenerator, 1, dof> getRelativeGeometricJacobian(const Eigen::Vector<T, dof> &positions,
                                                                                  const Motor<T> &reference = Motor<T>());
        ...
        MultivectorMatrix<T, Motor, 1, dof> getAbsoluteAnalyticJacobian(const Eigen::Vector<T, dof> &positions);
